...
To use Prisma Migrate with the database you introspected in the last section, you will need to [baseline your database](/guides/database/developing-with-prisma-migrate/add-prisma-migrate-to-a-project).
